...
class DLink(object):
    ...
    def generate(self, mac):
        ...
        # is 9,999,999 (7 digits). Since nic is a 3-byte value, the largest
        # possible value for nic is 16,777,215; thus the largest possible remainder
        # here is 6,777,215. The smallest possible remainder is, obviously, 0.
        pin = pin % int(10e6)

        # If the nic is less than 1,000,000 (i.e., less than 7 digits)
        if pin < int(10e5):
            # The largest possible remainder for any value divided by 9 is
            # 8; hence this adds at most 9,000,000 to the nic value, and at
            # least 1,000,000. This guarantees that the nic will be 7 digits
